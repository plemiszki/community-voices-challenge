...
# docker build -t community_voices_challenge .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name community_voices_challenge community_voices_challenge
